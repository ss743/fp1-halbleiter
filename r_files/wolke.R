...
plotlindata(xct,"\nmu_n*E (Slope)")
text(x=7.3*10^(-6),y=0.008, labels="x_c(t)=-(0.00199+-0.00016)+(473+-8)*t",cex=0.8)
...
plotexp(At,grenzen)
printexpdata(At,"\nLebensdauer")
text(x=1*10^(-5),y=2.4*10^(-7), labels="A(t)=*exp(-t/(5.4+-0.3)*10^6)",cex=0.8)
...
text(x=9*10^(-6),y=1.4*10^(-6), labels="sigma(t)=(1.5+-0.6)+sqrt((8.78+-0.15)*10^(-6)*t)",cex=0.8)
...
plotlindata(Ut,"\nmu_n/(x*l) (Slope)")
text(x=7.3*10^(-6),y=0.047, labels="1/U(t)=-(0.0079+-0.0005)+(4760+-70)*t",cex=0.8)
...
plotexp(At,grenzen)
printexpdata(At,"\nLebensdauer")
text(x=1*10^(-5),y=2*10^(-7), labels="A(t)=*exp(-t/(2.8+-0.5)*10^6)",cex=0.8)
...
grenzen=c(min(mu),max(mu))
grid()
st=sqrtfit(data.frame(x=mu,y=sigma,sy=ssigma),grenzen,TRUE)
plotsqrt(st,grenzen)
printsqrtdata(st,"\n2D_n (B)")
text(x=7.3*10^(-6),y=2*10^(-6), labels="sigma(t)=-(2.43+-0.16)+sqrt((1.72+-0.17)*10^(-6)*t)",cex=0.8)
